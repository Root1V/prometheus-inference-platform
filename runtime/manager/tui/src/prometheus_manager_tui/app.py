...
class ConfirmModal(ModalScreen[bool]):
    ...
    def __init__(self, action: str, model_id: str, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self._action = action
...
class ManagerApp(App[None]):
    ...
    def __init__(self, config: ManagerConfig, registry: Registry, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self._config = config
    ...
    def _start_with_capacity_check(self, model_id: str) -> None:
        ...
        from prometheus_manager_core.scanner import scan as _scan
    ...
    def action_registry_delete(self) -> None:
        try:
            ...
            table = view.query_one("#registry-table", DataTable)
            row = table.cursor_row
