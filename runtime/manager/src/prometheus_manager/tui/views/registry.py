...
class RegistryView(Vertical):
    ...
    def refresh_data(self, entries: list) -> None:
    ...
    def _add_entry_row(self, table: DataTable, e, *, dim: bool = False) -> None:
    ...
    def _update_detail(self, entry) -> None:
    ...
    def action_toggle_discovery(self) -> None:
        ...
        if not model_id:
            return
        self.app.action_registry_toggle_discovery(model_id)

    def action_add(self) -> None:
        self.app.action_registry_add()

    def action_delete(self) -> None:
        self.app.action_registry_delete()

    def action_download(self) -> None:
        self.app.action_registry_download()
