...
| RM-55 | Richer multi-instance-per-model management UX | todo | Mostly absorbed by RM-71's "Add instance" flow and model-level picker; what's left is the port-conflict-aware view and a side-by-side comparison of one model's instances |
