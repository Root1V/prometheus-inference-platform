...
| RM-48 | Dashboard: Models page — discover, download, and manage the model lifecycle | todo | Search Hugging Face, read the model card, download with progress/cancel/resume, and gate instance creation to only downloaded models |
